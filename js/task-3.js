...
як ім’я для привітання. Обов’язково очищай значення в інпуті по краях від пробілів . Якщо інпут порожній або містить лише пробіли, то замість імені у 
...
input.addEventListener("input", () => {
    const inputTextTrim = input.value.trim();
    if (inputTextTrim !== "" && input.value !== null && input.value !== undefined) {
        output.textContent = inputTextTrim;
    } else {
